    ...
    return ( 
        <div className="navbar flex items-center py-4 px-20 gap-6"> 
            <div className="logo flex flex-col items-start gap-2 flex-1"> 
                <img src={logoContainer} alt="logo arture" className="w-[8.6875rem] h-[2.22013rem]" /> 
            </div> 
            <nav className="flex justify-center items-center gap-4"> 
                <ul className="flex gap-4"> 
                    <li className="transition duration-300 ease-in-out hover:text-yellow-600"><Link to="/">Edukasi</Link></li> 
